...
public class ProductService {
    ...
    public ProductDto save(ProductDto productDto, MultipartFile multipartFile) {
        ...
        System.out.println("old " + productDto.getOldCost());
        System.out.println("new " + productDto.getCost());
        BigDecimal oldPrice = productDto.getOldCost();
        BigDecimal newPrice = productDto.getCost();

        product.setOldCost(newPrice);
...
//        final ProductDto savedProductDto = ;
    ...
    public ProductDto saveImage(Long productId, MultipartFile multipartFile) {
//        Product product = productMapper.toProduct(productDto, manufacturerDao, categoryDao);
