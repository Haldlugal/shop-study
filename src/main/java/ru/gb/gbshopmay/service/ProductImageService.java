...
//    private List<String> paths; // пути внутри storageLocation
    ...
    public String save(MultipartFile file) {
        ...
        System.out.println("want to save " + filename);
    ...
    public String save(MultipartFile file, String filename) {
        try {
            ...
            if (filename.contains("..")) {
                throw new StorageException(String.format("Symbol '..' is not permitted"));
            }
    ...
    public ArrayList<String> loadMultipleImageNames(Long id) {
        return productImageDao.findMultipleImageNamesByProductId(id);
    }

    public BufferedImage loadFileAsImageByName(String name) throws IOException {
